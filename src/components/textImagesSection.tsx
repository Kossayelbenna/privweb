...
const TextImagesSection = React.memo(() => {
  ...
  const OrbitingContent = useMemo(() => (
    <div className="relative flex h-[500px] w-[500px] items-center justify-center overflow-hidden sm:-mt-24 -mt-40">
      <div className="absolute flex items-center justify-center w-full h-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <img src="/images/shiba.png" alt="" className="absolute w-[100px] h-[100px]" />
      </div>
      {[
        { src: "/images/bitcoin-4976783-4159449.png", radius: 80, duration: 20, delay: 20 },
        { src: "/images/polygon-4976786-4159452.webp", radius: 80, duration: 20, delay: 10 },
        { src: "/images/solana-4976792-4159458.png", radius: 140, duration: 25, delay: 0, reverse: true },
        { src: "/images/cosmos-4976793-4159459.png", radius: 140, duration: 25, delay: 12.5, reverse: true },
        { src: "/images/ethereum-9855399-8000714.webp", radius: 200, duration: 30, delay: 0 },
        { src: "/images/cardano-4976784-4159450.png", radius: 200, duration: 30, delay: 15 },
      ].map((circle, index) => (
        <OrbitingCircles
          key={index}
        ...
        >
          <img src={circle.src} alt="" className="w-12 h-12" />
        </OrbitingCircles>
      ))}
    </div>
  ), []);
